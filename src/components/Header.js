...
const Header = () => {
    return (
        <div className='d-flex align-items-center'>
            <div className='container-fluid flex-1 w-1/5 border min-h-screen p-5 bg-black'>
                ...
                <div className='mt-3 mx-2 text-cyan-100 border flex flex-col justify-between min-h-screen'>
                    <div>
